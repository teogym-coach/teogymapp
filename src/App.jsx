...
// ─── CSS ───
const CSS = `@import url('https://fonts.googleapis.com/css2?family=DM+Mono:wght@400;500&family=Syne:wght@700;800&family=Noto+Sans+KR:wght@400;500;700;900&display=swap'); *{box-sizing:border-box;margin:0;padding:0;} html,body,#root{min-height:100%;min-height:-webkit-fill-available;} html{height:-webkit-fill-available;} body{background:#09090c;color:#ddddf0;font-family:'Noto Sans KR',sans-serif;-webkit-text-size-adjust:100%;overscroll-behavior:none;} input,textarea,select{font-family:'Noto Sans KR',sans-serif;background:#111116;border:1px solid #21212a;color:#ddddf0;border-radius:7px;padding:8px 12px;font-size:16px;width:100%;outline:none;transition:border-color .18s;-webkit-appearance:none;} input:focus,textarea:focus,select:focus{border-color:#00e5a0;box-shadow:0 0 0 3px rgba(0,229,160,.07);} input::placeholder,textarea::placeholder{color:#2e2e3e;} select option{background:#111116;} textarea{resize:vertical;min-height:54px;} label{display:block;font-family:'DM Mono',monospace;font-size:10px;color:#54546a;margin-bottom:4px;letter-spacing:.08em;text-transform:uppercase;} button{cursor:pointer;font-family:'Syne',sans-serif;-webkit-tap-highlight-color:transparent;} ::-webkit-scrollbar{width:4px;}::-webkit-scrollbar-track{background:#09090c;}::-webkit-scrollbar-thumb{background:#21212a;border-radius:4px;} @keyframes spin{to{transform:rotate(360deg)}} @keyframes fi{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}} @media(max-width:600px){.g3{grid-template-columns:1fr 1fr!important;}.g2{grid-template-columns:1fr!important;}} @media print{.noprint{display:none!important;}#pportal{display:block!important;position:fixed;top:0;left:0;width:210mm;}body{background:#fff!important;-webkit-print-color-adjust:exact;print-color-adjust:exact;}}`;
...
function removeEx(ei) { setExercises(prev => prev.filter((*,i) => i!==ei)); }
...
function removeSet(ei, si) { setExercises(prev => prev.map((ex,i) => i===ei ? {…ex,sets:ex.sets.filter((*,j)=>j!==si)} : ex)); }
...
// 운동 이름을 입력할 때 키워드가 포함되면 해당 카테고리로 자동 배치됨
const CATEGORY_ORDER = {
“하체”: [
{ label:“맨몸 스쿼트 계열”,       keywords:[“맨몸 스쿼트”,“점프 스쿼트”,“와이드 스쿼트”,“월 스쿼트”] },
{ label:“바벨·머신 스쿼트 계열”,  keywords:[“바벨 스쿼트”,“바벨 백 스쿼트”,“바벨 프론트 스쿼트”,“브이스쿼트”,“스미스 머신 스쿼트”,“핵 스쿼트”,“컨벤셔널 데드리프트”,“고블릿 스쿼트”] },
{ label:“레그프레스 계열”,         keywords:[“레그프레스”,“leg press”] },
{ label:“레그 익스텐션”,           keywords:[“레그 익스텐션”,“레그익스텐션”,“leg extension”] },
{ label:“햄스트링 계열”,           keywords:[“레그컬”,“레그 컬”,“스티프 레그”,“루마니안 데드리프트”,“nordic”,“노르딕”] },
{ label:“둔근 계열”,               keywords:[“힙 쓰러스트”,“힙쓰러스트”,“킥백”,“글루트”,“힙 어브덕션”,“브릿지”,“클램”] },
{ label:“이너 싸이 (내전근)”,      keywords:[“이너”,“어덕션”,“수모”] },
{ label:“런지 계열”,               keywords:[“런지”,“스플릿 스쿼트”,“불가리안”] },
{ label:“종아리 계열”,             keywords:[“카프”,“종아리”,“calf”] },
],
“등”: [
{ label:“풀다운 계열”,             keywords:[“랫풀다운”,“풀다운”,“풀업”,“친업”,“pulldown”,“pull up”,“pullup”,“스트레이트 암”,“풀오버”] },
{ label:“시티드 케이블 로우”,      keywords:[“시티드 케이블 로우”,“시티드케이블로우”,“seated cable row”] },
{ label:“바벨 로우 계열”,          keywords:[“바벨 로우”,“바벨로우”,“펜들레이”,“t바”,“t-바”] },
{ label:“덤벨 로우 계열”,          keywords:[“덤벨 로우”,“덤벨로우”,“원암 로우”,“인클라인 덤벨 로우”] },
{ label:“루마니안 데드리프트”,     keywords:[“루마니안”,“스모 데드”,“컨벤셔널 데드”,“rdl”] },
],
“가슴”: [
{ label:“푸쉬업 계열”,             keywords:[“푸쉬업”,“푸시업”,“push up”,“pushup”] },
{ label:“가운데 가슴 — 프레스”,   keywords:[“벤치프레스”,“벤치 프레스”,“벤치”,“체스트 프레스”,“chest press”] },
{ label:“가운데 가슴 — 플라이”,   keywords:[“펙덱”,“케이블 크로스”,“플라이”,“pec dec”,“flye”,“fly”] },
{ label:“윗가슴 — 프레스”,        keywords:[“인클라인 벤치”,“인클라인벤치”,“스미스 머신 인클라인”,“인클라인 프레스”] },
{ label:“윗가슴 — 플라이”,        keywords:[“인클라인 플라이”,“인클라인플라이”,“어퍼 크로스”,“upper cross”] },
{ label:“아랫가슴 계열”,           keywords:[“딥스”,“dips”,“디클라인”,“로우 케이블 크로스”] },
],
“어깨”: [
{ label:“프레스 계열”,             keywords:[“프레스”,“press”,“아놀드”,“밀리터리”] },
{ label:“측면 삼각근 — 레이즈”,   keywords:[“사이드 레이즈”,“사이드레이즈”,“업라이트 로우”,“side raise”,“lateral”] },
{ label:“전면 삼각근 — 레이즈”,   keywords:[“프론트 레이즈”,“프론트레이즈”,“front raise”] },
{ label:“후면 삼각근 — 레이즈”,   keywords:[“리어 레이즈”,“리어레이즈”,“페이스풀”,“리버스 펙덱”,“리버스 플라이”,“rear”,“face pull”] },
],
“팔-이두근”: [
{ label:“바벨 컬 계열”,            keywords:[“바벨 컬”,“바벨컬”,“ez바 컬”,“ez컬”,“프리처 컬 (바벨)”] },
{ label:“덤벨 컬 계열”,            keywords:[“덤벨 컬”,“덤벨컬”,“얼터네이트”,“인클라인 덤벨 컬”,“컨센트레이션”,“프리처 컬 (덤벨)”] },
{ label:“케이블 컬 계열”,          keywords:[“케이블 컬”,“케이블컬”,“하이 케이블”] },
{ label:“해머·리버스 컬”,          keywords:[“해머 컬”,“해머컬”,“크로스 바디”,“리버스 컬”,“리버스컬”] },
],
“팔-삼두근”: [
{ label:“외측두 운동”,             keywords:[“푸시다운”,“푸쉬다운”,“pushdown”] },
{ label:“내측두 운동”,             keywords:[“클로즈 그립”,“다이아몬드”,“벤치 딥스”] },
{ label:“장두 운동”,               keywords:[“오버헤드”,“overhead”,“익스텐션”] },
{ label:“전체 삼두 운동”,          keywords:[“스컬 크러셔”,“킥백”,“딥스”,“트라이셉스”] },
],
};

// 운동 이름이 카테고리 키워드와 매칭되는지 확인 (부분 일치)
