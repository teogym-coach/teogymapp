...
const checks = [
  ...
  // 중량별로 항목을 따로 만들지 않고 100g 기준값 하나만 두고 기존 비례 계산에 맡긴다.
  ["음식 데이터: 고구마줄기 무침은 100g 기준 1건만 등록한다(중량별 중복 항목 금지)",
    app.includes('{name:"고구마줄기 무침",unit:"g",  per:100, cal:60,  carb:8.0,  protein:2.0,  fat:2.0},') &&
    (app.match(/\{name:"고구마줄기/g) || []).length === 1
  ],
