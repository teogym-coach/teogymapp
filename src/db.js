...
// 수업 일지 (sessions)
// ════════════════════════════════════════════════════
const SESSION_PUBLIC_FIELDS = new Set(["name", "sets", "feedback", "muscleTop", "muscleSub", "equipment", "unitType", "movementPurpose", "funcCategory", "funcBodyPart", "funcTool", "isFavorite", "favorite", "isRecommended", "recommended", "memberAppRecommended", "stimRating", "stimMemo"]);
